<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('dashboard.waste.index') }}"
                        :active="request()->routeIs('dashboard.waste.index')">
                        {{ __('Wastes') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('dashboard.coinWithdrawal.index') }}"
                        :active="request()->routeIs('dashboard.coinWithdrawal.index')">
                        {{ __('Coin Withdrawal') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->roles == 'ADMIN')
            <x-jet-responsive-nav-link href="{{ route('dashboard.waste.index') }}"
                :active="request()->routeIs('dashboard.waste.index')">
                {{ __('Waste') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('dashboard.coinWithdrawal.index') }}"
                :active="request()->routeIs('dashboard.coinWithdrawal.index')">
                {{ __('Coin Withdrawal') }}
            </x-jet-responsive-nav-link>
